...
export function Sintomas() {
  const listaSintomas = [
    ...
    "Rigidez ao acordar pela manhã.",
    "Dificuldade para caminhar longas distâncias.",
    "Estalos e travamentos no joelho.",
    "Limitação para praticar exercícios ou até tarefas simples.",
  ];
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 md:grid-cols-2 z-10">
        <FadeIn>
          ...
          <div className="mt-8 space-y-4 text-muted md:text-lg">
             <p>
              Com o passar dos anos e o desgaste natural, a cartilagem do joelho perde elasticidade e o líquido sinovial diminui.
            </p>
            <p className="text-text">
              O ácido hialurônico atua como um "lubrificante" e "amortecedor" natural, reduzindo o atrito, aliviando a dor e permitindo que você volte a realizar atividades do dia a dia com mais conforto.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <div className="overflow-hidden rounded-2xl border border-line/40 bg-bg/60 shadow-lg ring-1 ring-white/5">
            <img
              ...
              alt="Ilustração do tratamento com ácido hialurônico"
