          ...
          <div className="relative overflow-hidden rounded-2xl border border-line/40 bg-[linear-gradient(180deg,rgba(8,38,51,0.85),rgba(7,24,34,0.9))] p-6 shadow-2xl ring-1 ring-white/5 md:p-12">
            ...
            <div className="relative mx-auto max-w-3xl text-center">
              ...
              <div className="mt-4 text-muted md:mt-6">
                <FadeIn delay={0.05}>
                  <p>
                    O desgaste da cartilagem é progressivo — quanto antes iniciar o tratamento, melhores serão os resultados e menores as chances de precisar de cirurgia no futuro.
                  </p>
                </FadeIn>
              </div>
              <FadeIn delay={0.15}>
                <div className="mt-8">
                  ...
                  >
                    <a href="https://wa.me/+555585994326619?text=Ol%C3%A1,%20gostaria%20de%20agendar%20uma%20avalia%C3%A7%C3%A3o%20para%20descobrir%20o%20protocolo%20ideal%20para%20o%20meu%20joelho.">
                      Descubra o protocolo ideal para o seu joelho
                    </a>
                  </Button>
                </div>
              </FadeIn>
